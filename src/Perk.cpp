...
void Perk::draw() {
    ...
    case PERK_SPEED_BOOST:
        ...
        glBegin(GL_TRIANGLES);
        glVertex2f(cx, cy - r*0.6f); glVertex2f(cx - r*0.5f, cy); glVertex2f(cx + r*0.5f, cy);
        glVertex2f(cx, cy + r*0.2f); glVertex2f(cx - r*0.5f, cy + r*0.8f); glVertex2f(cx + r*0.5f, cy + r*0.8f);
        glEnd();
        glColor3f(0.6f, 1.0f, 0.6f);
        drawNGonOutline(cx, cy, r + 2, 32);
        break;

    case PERK_CRITICAL_BOOST:
        // Yellow crosshair / target
        glColor3f(1.0f, 0.9f, 0.2f);
        drawNGonOutline(cx, cy, r*0.6f, 16);
        glBegin(GL_LINES);
        glVertex2f(cx - r*0.8f, cy); glVertex2f(cx + r*0.8f, cy);
        glVertex2f(cx, cy - r*0.8f); glVertex2f(cx, cy + r*0.8f);
        glEnd();
        glColor3f(1.0f, 1.0f, 0.5f);
        drawNGonOutline(cx, cy, r + 2, 32);
        break;

    case PERK_DAMAGE_BOOST:
        // Red sword/dagger shape
        glColor3f(1.0f, 0.2f, 0.2f);
        glBegin(GL_TRIANGLES);
        glVertex2f(cx, cy - r*0.8f); glVertex2f(cx - r*0.3f, cy + r*0.4f); glVertex2f(cx + r*0.3f, cy + r*0.4f);
        glEnd();
        glColor3f(0.8f, 0.1f, 0.1f);
        glBegin(GL_QUADS);
        glVertex2f(cx - r*0.1f, cy + r*0.4f); glVertex2f(cx + r*0.1f, cy + r*0.4f);
        glVertex2f(cx + r*0.1f, cy + r*0.8f); glVertex2f(cx - r*0.1f, cy + r*0.8f);
        glEnd();
    ...
    case PERK_SLOW_TIME:
        // Light blue hourglass/clock
        glColor3f(0.2f, 0.8f, 1.0f);
        glBegin(GL_TRIANGLES);
        glVertex2f(cx, cy); glVertex2f(cx - r*0.5f, cy - r*0.6f); glVertex2f(cx + r*0.5f, cy - r*0.6f);
        glVertex2f(cx, cy); glVertex2f(cx - r*0.5f, cy + r*0.6f); glVertex2f(cx + r*0.5f, cy + r*0.6f);
        glEnd();
    ...
    case PERK_SPEED_BOOST:  label = "SPEED"; break;
    case PERK_CRITICAL_BOOST: label = "CRIT"; break;
    case PERK_DAMAGE_BOOST: label = "DAMAGE"; break;
    case PERK_SLOW_TIME:    label = "SLOW"; break;
    }
